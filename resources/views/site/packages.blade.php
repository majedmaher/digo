...
<section id="how-we-work">
    <div class="how-we-work">
        ...
        <ul>
            <li>
                <img src="{{asset('images/idea.webp')}}" alt="تقديم الطلب ">
                <h3> تقديم الطلب </h3>
            ...
            <li>
                <img src="{{asset('images/budget.webp')}}" alt="عرض السعر ">
                <h3> عرض السعر </h3>
            ...
            <li>
                <img src="{{asset('images/handshake.webp')}}" alt=" توقيع العقد  ">
                <h3> توقيع العقد </h3>
            ...
            <li>
                <img src="{{asset('images/search.webp')}}" alt="التحليل ">
                <h3> التحليل </h3>
                <p class="p-more"> نستمع جيداً لما يطلبه العميل و نحدد له المناسب من الخدمات و
                    التقنيات التي تساعده على النجاح في أعماله </p>
                <i></i>
            ...
            <li>
                <img src="{{asset('images/power.webp')}}" alt="البدء في التنفيذ">
            ...
            <li>
                <img src="{{asset('images/notepad.webp')}}" alt="التسليم المبدئي">
            ...
            <li>
                <img src="{{asset('images/list.webp')}}" alt="التسليم النهائي">
