    ...
    <div class="col-md-12">
      ...
      <form action="{{route('work.update',['id'=> $work->id])}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <input type="text" name="description" class="form-control" value="{{$work->description}}"></input>
        </div>
        ...
        <div class="form-group">
          ...
          <input type="text" name="behance" class="form-control" value="{{$work->behance}}">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input type="number" name="arrangement" class="form-control" min="0" value="{{$work->arrangement}}"></input>
        </div>
...
<script>
  $('#summernote').summernote({
    placeholder: 'Enter the work content',
    tabsize: 2,
    height: 100
  });
</script>
