    ...
    <div class="col-md-12">
      ...
      <form action="{{route('slider.store')}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <input type="text" name="more_btn" class="form-control">
        </div>
        <div class="form-group">
          <label for="exampleFormControlTextarea1"> رابط المزيد </label>
          <input type="text" name="more_link" class="form-control">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <button class="btn btn-danger" type="submit">حفظ السلايدر</button>
        </div>
