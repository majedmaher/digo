    ...
    <div class="col-md-12">
      ...
      <form action="{{route('mail.store')}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <textarea name="body_text_one" id="summernote"></textarea>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <textarea name="body_text_two" id="summernote2"></textarea>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input type="text" name="button_three" class="form-control">
        </div>
        <div class="form-group">
          <label for="exampleFormControlInput1">الرابط الثالث </label>
          <input type="text" name="button_three_link" class="form-control">
        </div>
        <div class="form-group">
