    ...
    <div class="col-md-12">
      ...
      <form action="{{route('packages.store')}}" method="POST">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control @error('description') is-invalid @enderror" name="description" value="{{old('description')}}" data-role="tagsinput" required>
        </div>
        ...
        <div class="form-group">
          ...
          <input name="currencyـname" type="text">
        </div>

        <div class="form-group">
          <label for="exampleFormControlInput1">اختصار العملة المعتمد </label>
          <input name="currencyـabbreviation" type="text">
        </div>
